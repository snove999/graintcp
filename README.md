...
| `test_harness.mjs` | 本地 | 374 项离线回归测试（Node ≥ 22，实测 v22.22.2 / v24.19.0 全绿） |
...
- 明文/混淆交叉验证：`worker.obf.js` 通过同一套 **374 项**回归。
